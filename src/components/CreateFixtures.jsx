...
function CreateFixtures() {
  ...
  return (
    <section>
      ...
      <div>
        <SingleFixtures count="One" season={Season} matchday={Matchday} />
        <SingleFixtures count="Two" season={Season} matchday={Matchday} />
        <SingleFixtures count="Three" season={Season} matchday={Matchday} />
        <SingleFixtures count="Four" season={Season} matchday={Matchday} />
        <SingleFixtures count="Five" season={Season} matchday={Matchday} />
        <SingleFixtures count="Six" season={Season} matchday={Matchday} />
